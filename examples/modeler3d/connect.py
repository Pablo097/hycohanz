...
input('Press "Enter" to draw two red three-vertex polylines named Triangle1 and Triangle2.>')
...
input('Press "Enter" create a volume from these polylines using the Connect operation.>')
